...
#define      macGetGBKCode( ucBuffer, usChar )  GetGBKCode_from_EXFlash( ucBuffer, usChar )	  //定义获取中文字符字模数组的函数名，ucBuffer为存放字模数组名，usChar为中文字符（国标码）



/******************************* 定义 ILI934 显示屏常用颜色 ********************************/
#define      macBACKGROUND		                macYELLOW  //默认背景颜色

#define      macWHITE		 		                  0xFFFF	   //白色
#define      macBLACK                         0x0000	   //黑色 
#define      macGREY                          0xF7DE	   //灰色 
#define      macGREY1                         0x8410	   //灰色 
#define      macBLUE                          0x001F	   //蓝色
#define      macBLUE2                         0x5CDA	   //浅蓝色 
