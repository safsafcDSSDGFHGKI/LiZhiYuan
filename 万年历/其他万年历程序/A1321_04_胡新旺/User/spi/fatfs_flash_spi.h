...
/*SPI接口*/
#define macFLASH_SPI                           SPI1
#define macRCC_APBxPeriphClockCmd_FUN          RCC_APB2PeriphClockCmd
#define macFLASH_SPI_CLK                       RCC_APB2Periph_SPI1
#define macFLASH_SPI_GPIO_CLK                  RCC_APB2Periph_GPIOA

#define macFLASH_SPI_SCK_PIN                   GPIO_Pin_5                  /* PA.05 */
#define macFLASH_SPI_SCK_GPIO_PORT             GPIOA                       /* GPIOA */

#define macFLASH_SPI_MISO_PIN                  GPIO_Pin_6                  /* PA.06 */
#define macFLASH_SPI_MISO_GPIO_PORT            GPIOA                       /* GPIOA */
...
#define SPI_FLASH_CS_LOW()      GPIO_ResetBits(macFLASH_CS_GPIO_PORT, macFLASH_CS_PIN)				//输出低电平 GPIO_ResetBits(FLASH_CS_GPIO_PORT, FLASH_CS_PIN)
