...
int main(void)
{
	...
	LCD12864_DisplayStrChin(0 ,0,"李正海");
	LCD12864_DisplayStrChin(0 ,4,"万年历");
	LCD12864_DisplayStrChin(0 ,8,"毕业设计");
	//LCD12864_DrowPic(0,0,128,64,KaiJiDongHua);                        // 显示开机动画
	
	Delay_ms(30000);                                                   // 延时，用于开机动画的显示时间
 	LCD12864_DrawClear();                                             // LCD12864清屏 画点方式
	LCD12864_Clear(); 
...
//			LCD12864_DrowSet(96,48,16,16,31,0);LCD12864_DrowSet(112,48,16,16,32,0);         // 显示退出
	...
	*/
	...
	{
		//LCD12864_DrowPic(0,0,128,16,Li_Zhenghai);                        // 显示开机动画
